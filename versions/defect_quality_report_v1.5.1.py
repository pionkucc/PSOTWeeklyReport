...
def create_pie_chart(data, title, hole=0.4, colors=None, height=350):
    """创建饼图"""
...
def create_bar_chart(data, title, orientation='v', colors=None, height=350, x_label='', y_label='数量', show_legend=False, order=None):
    """创建柱状图"""
    counts = data.value_counts()
